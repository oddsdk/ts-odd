...
export type Implementation = {
  ...
  /**
   *
   * Request an (email) Verification Code from the account system.
   */
  ...
  register: (
    formValues: Record<string, string>,
    identifierUcan: Ucan
  ) => Promise<{ ok: true; ucans: Ucan[] } | { ok: false; reason: string }>;
   ...
   */
  canUpdateDataRoot: (
    identifierUcans: Ucan[],
    ucanDictionary: UcanDictionary
  ) => Promise<boolean>;
