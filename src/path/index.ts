...
export function rootBranch(path: DistinctivePath<Segments>): Maybe<{ branch: RootBranch; rest: Segments }> {
  ...
  switch (firstSegment) {
    case RootBranch.Exchange:
      return { branch: RootBranch.Exchange, rest }
    case RootBranch.Private:
      return { branch: RootBranch.Private, rest }
    case RootBranch.Public:
      return { branch: RootBranch.Public, rest }
    case RootBranch.Unix:
      return { branch: RootBranch.Unix, rest }
    case RootBranch.Version:
      return { branch: RootBranch.Version, rest }
