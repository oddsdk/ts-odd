...
test("UCAN can be built", async ({ page }) => {
...
test("UCAN can validate a UCAN with a valid proof", async ({ page }) => {
  await loadWebnativePage(page)
...
test("UCAN can validate a UCAN with a sessionKey fact", async ({ page }) => {
  await loadWebnativePage(page)
...
test("decodes and reencodes UCAN to the same value", async ({ page }) => {
  await loadWebnativePage(page)
