...
test('publicKeyToDid handles RSA Keys', async ({ page }) => {
...
test('publicKeyToDid handles Ed25519 Keys', async ({ page }) => {
  await loadWebnativePage(page)
...
test('publicKeyToDid handles BLS12-381 Keys', async ({ page }) => {
  await loadWebnativePage(page)
