...
describe("publicKeyToDid", () => {
  ...
  it("handles RSA Keys", async function() {
    ...
    const d = did.publicKeyToDid(pubkey, did.KeyType.RSA)
  ...
  it("handles Ed25519 Keys", async function() {
    ...
    const d = did.publicKeyToDid(pubkey, did.KeyType.Edwards)
  ...
  it("handles BLS12-381 Keys", async function() {
    ...
    const pubkey = "Hv+AVRD2WUjUFOsSNbsmrp9fokuwrUnjBcr92f0kxw4="
    const d = did.publicKeyToDid(pubkey, did.KeyType.BLS)
